import { question_1 } from '../question.js';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function shuffleQuestions() {
        for (let i = question_1.length - 1; i > 0; i--) {
            const j = Math.floor(Math.random() * (i + 1));
            [question_1[i], question_1[j]] = [question_1[j], question_1[i]];
        }
    }
